...
class PerfilForm(forms.ModelForm):
    class Meta:
        model = models.Perfil
        fields = '__all__' #TODO todos os campos
        exclude = ('usuario',) #excluiu o campo usuario
